...
<!-- Nội dung dưới đây được nhập từ chương kết luận cũ, gồm phần đối chiếu mục tiêu và vấn đề còn tồn đọng. Số thứ tự mục gốc được giữ tạm thời để tiện đối chiếu; cần biên tập lại thành các mục 5.x theo OUTLINE.md. -->
...
- Cần diễn giải thêm ý nghĩa của các chức năng đạt và chưa đạt, thay vì chỉ trình bày bảng đối chiếu.
- Cần kiểm tra lại bảng Markdown tại phần “Hủy đặt phòng” vì trong bản gốc bảng bị tách dòng.
- Các nhận định về hiệu suất, bảo mật, responsive và xác thực API cần minh chứng kiểm thử hoặc nguồn/dữ liệu nội bộ rõ ràng.
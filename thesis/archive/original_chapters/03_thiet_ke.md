...
<!-- Chương này được nhập từ chương thiết kế cũ và giữ nguyên phần lớn bảng, sơ đồ PlantUML, mô hình dữ liệu, use case chi tiết, sơ đồ tuần tự, sơ đồ hoạt động và hệ thống màn hình. -->

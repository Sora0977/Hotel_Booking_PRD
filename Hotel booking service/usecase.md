...
' Thu hẹp khoảng cách dọc và nới rộng khoảng cách ngang để ưu tiên khổ A4 ngang
...
rectangle "Hệ thống Quản lý Khách sạn" {
  ...
  ' ========================================================
  ' TRỤC XƯƠNG SỐNG TẠO CHIỀU NGANG CHO GIẤY A4 (Landscape)
  ' Chia Use Case thành 4 cột chính để mở rộng chiều ngang
  ' ========================================================
  UC_Login -[hidden]right-> UC_Manage_Profile
  UC_Manage_Profile -[hidden]right-> UC_Manage_Hotel_Info
  UC_Manage_Hotel_Info -[hidden]right-> UC_Manage_All_Users

  UC_Search_Filter -[hidden]right-> UC_Book_Pay
  UC_Book_Pay -[hidden]right-> UC_Manage_Bookings
  UC_Manage_Bookings -[hidden]right-> UC_Manage_Transactions

  UC_View_Hotel -[hidden]right-> UC_Favorite_Hotel
  UC_Favorite_Hotel -[hidden]right-> UC_Manage_Rooms
  UC_Manage_Rooms -[hidden]right-> UC_Manage_Facilities

  UC_View_Room_Detail -[hidden]right-> UC_Cancel_Booking
  UC_Cancel_Booking -[hidden]right-> UC_Manage_Policies
  UC_Manage_Policies -[hidden]right-> UC_Manage_Hotel_Status
}
...
Customer -up-|> User
Business -up-|> User
' Các Actor bên phải trỏ sang trái để đường thẳng không bị rối và giữ vị trí
Manager -left-|> User
Admin -left-|> User
...
' Từ Người dùng (Giữ nguyên bên trái)
User -- UC_Login
User -- UC_Register
User -- UC_Forgot_Password
User -- UC_Change_Password
...
' Từ Khách hàng (Giữ nguyên bên trái)
Customer -- UC_Manage_Profile
Customer -- UC_Favorite_Hotel
Customer -- UC_Rate_Hotel
Customer -- UC_Book_Pay
...
' Từ Doanh nghiệp (Giữ nguyên bên trái)
Business -- UC_Register_New_Hotel
Business -- UC_Manage_Hotel_Catalog
Business -- UC_Manage_HR
...
' Từ Quản lý (UseCase đứng trước, Actor đứng sau)
...
' Từ Quản trị viên (UseCase đứng trước, Actor đứng sau)

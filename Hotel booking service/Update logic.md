...
- Người dùng mới thực hiện đăng ký bằng cách cung cấp họ tên, email, số điện thoại, ngày/năm sinh và mật khẩu.
...
## 2. Tìm kiếm, xem khách sạn và kiểm tra phòng trống
...
### Xem thông tin chi tiết phòng khách sạn
...
## 3. Hồ sơ khách hàng, yêu thích và đánh giá
...
## 4. Đặt phòng, thanh toán, lịch sử và hủy đặt phòng

### Đặt phòng khách sạn và thanh toán
...
## 5. Đăng ký và quản lý khách sạn của Doanh nghiệp
...
### Quản lý chính sách và điều khoản khách sạn
...
- Quản lý và Doanh nghiệp xem báo cáo theo phạm vi quyền hạn của mình.
...
### Quản lý trạng thái hoạt động của tất cả khách sạn
...
### Quản lý ký khách sạn từ đối tác
...
## 8. Mở rộng: Tích điểm, uy tín khách sạn và ưu đãi khi đánh giá

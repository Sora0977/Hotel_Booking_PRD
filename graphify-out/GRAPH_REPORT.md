...
- [[_COMMUNITY_main.js  createFilter()  createStashReflogEntry()|main.js / createFilter() / createStashReflogEntry()]]
- [[_COMMUNITY_UE()  Mt()  hu()|UE() / Mt() / hu()]]
- [[_COMMUNITY_J()  from()  Ar()|J() / from() / Ar()]]
- [[_COMMUNITY_3.2.2 Sơ đồ tuần tự  codeplantuml (@startuml)|3.2.2 Sơ đồ tuần tự / code:plantuml (@startuml)]]
- [[_COMMUNITY_3.2.3 Sơ đồ hoạt động (activity)  codeplantuml (@startuml)|3.2.3 Sơ đồ hoạt động (activity) / code:plantuml (@startuml)]]
- [[_COMMUNITY_data.json  authorInHistoryView  autoBackupAfterFileChange|data.json / authorInHistoryView / autoBackupAfterFileChange]]
- [[_COMMUNITY_push()  gR()  mA()|push() / gR() / mA()]]
- [[_COMMUNITY_core-plugins.json  audio-recorder  backlink|core-plugins.json / audio-recorder / backlink]]
- [[_COMMUNITY_get()  set()  has()|get() / set() / has()]]
- [[_COMMUNITY_toString()  filter()  _6()|toString() / filter() / _6()]]
- [[_COMMUNITY_hiddenItems  right  workspace.json|hiddenItems / right / workspace.json]]
- [[_COMMUNITY_main.js  setState()  onload()|main.js / setState() / onload()]]
- [[_COMMUNITY_activateFeature()  deactivateFeature()  destroy()|activateFeature() / deactivateFeature() / destroy()]]
- [[_COMMUNITY_2.3.1 Các quy trình, nghiệp vụ  CHƯƠNG 2. PHƯƠNG PHÁP THỰC HIỆN  2.2.2 Phía Backend|2.3.1 Các quy trình, nghiệp vụ / CHƯƠNG 2. PHƯƠNG PHÁP THỰC HIỆN / 2.2.2 Phía Backend]]
- [[_COMMUNITY_b()  TB()  XF()|b() / TB() / XF()]]
- [[_COMMUNITY_slice()  Av()  read()|slice() / Av() / read()]]
- [[_COMMUNITY_join()  exists()  remove()|join() / exists() / remove()]]
- [[_COMMUNITY_srcgit.js()  c  u|"src/git.js"() / c / u]]
- [[_COMMUNITY_zB()  connectedCallback()  Ic()|zB() / connectedCallback() / Ic()]]
- [[_COMMUNITY_pull()  commit()  displayMessage()|pull() / commit() / displayMessage()]]
- [[_COMMUNITY_pr()  UH()  eW()|pr() / UH() / eW()]]
- [[_COMMUNITY_3.2.1 Use case chi tiết  3.2.1.10 Usecase đặt phòng  3.2.1.11 Usecase tra cứu và hủy đơn đặt phòng|3.2.1 Use case chi tiết / 3.2.1.10 Usecase đặt phòng / 3.2.1.11 Usecase tra cứu và hủy đơn đặt phòng]]
- [[_COMMUNITY_resolve()  yA()  writeRef()|resolve() / yA() / writeRef()]]
- [[_COMMUNITY_displayError()  setPluginState()  branchInfo()|displayError() / setPluginState() / branchInfo()]]
- [[_COMMUNITY_render()  jA()  wL()|render() / jA() / wL()]]
- [[_COMMUNITY_hk()  h6()  oid()|hk() / h6() / oid()]]
- [[_COMMUNITY_fromBuffer()  readSlice()  eof()|fromBuffer() / readSlice() / eof()]]
- [[_COMMUNITY_srclibsimple-git-api.ts()  Rr()  srclibresponsesStatusSummary.ts()|"src/lib/simple-git-api.ts"() / Rr() / "src/lib/responses/StatusSummary.ts"()]]
- [[_COMMUNITY_graph.json  centerStrength  close|graph.json / centerStrength / close]]
- [[_COMMUNITY_getRepo()  wrapFS()  fetch()|getRepo() / wrapFS() / fetch()]]
- [[_COMMUNITY_error()  log()  _init()|error() / log() / _init()]]
- [[_COMMUNITY_on()  createEventHandlers()  addTask()|on() / createEventHandlers() / addTask()]]
- [[_COMMUNITY_dr()  exec()  fL()|dr() / exec() / fL()]]
- [[_COMMUNITY_Community 33|Community 33]]
- [[_COMMUNITY_zi()  pA()  Gs()|zi() / pA() / Gs()]]
- [[_COMMUNITY_OF()  dispatch()  XS()|OF() / dispatch() / XS()]]
- [[_COMMUNITY_sp()  diff()  diffWithOptionsObj()|sp() / diff() / diffWithOptionsObj()]]
- [[_COMMUNITY_h_()  kH()  Gt()|h_() / kH() / Gt()]]
- [[_COMMUNITY_add()  ensure()  append()|add() / ensure() / append()]]
- [[_COMMUNITY_lineAuthor  authorDisplay  coloringMaxAge|lineAuthor / authorDisplay / coloringMaxAge]]
- [[_COMMUNITY_acquire()  ga()  tA()|acquire() / ga() / tA()]]
- [[_COMMUNITY_write()  Ev()  x8()|write() / Ev() / x8()]]
- [[_COMMUNITY_Wi()  sign()  headers()|Wi() / sign() / headers()]]
- [[_COMMUNITY_addLineAuthorInfoSettings()  createColorSetting()  computeSigns()|addLineAuthorInfoSettings() / createColorSetting() / computeSigns()]]
- [[_COMMUNITY_vg()  Nn()  pL()|vg() / Nn() / pL()]]
- [[_COMMUNITY_Uv()  Xi()  nh()|Uv() / Xi() / nh()]]
- [[_COMMUNITY_f9()  GE()  aM()|f9() / GE() / aM()]]
- [[_COMMUNITY_3.1 Mô hình dữ liệu (mức ý niệm, mức luận lý, mức vậT lý)  CHƯƠNG 3 THIẾT KẾ  3.2 Mô hình xử lý|3.1 Mô hình dữ liệu (mức ý niệm, mức luận lý, mức vậT lý) / CHƯƠNG 3: THIẾT KẾ / 3.2 Mô hình xử lý]]
- [[_COMMUNITY_getHunk()  vy()  getHunkAtPos()|getHunk() / vy() / getHunkAtPos()]]
- [[_COMMUNITY_ut()  fM()  oS()|ut() / fM() / oS()]]
- [[_COMMUNITY_ba()  lL()  hy()|ba() / lL() / hy()]]
- [[_COMMUNITY_CHƯƠNG 1. GIỚI THIỆU  1.1 ĐẶT VẤN ĐỀ, MỤC TIÊU LUẬN VĂN  1.3 NỘI DUNG, PHẠM VI THỰC HIỆN|CHƯƠNG 1. GIỚI THIỆU / 1.1 ĐẶT VẤN ĐỀ, MỤC TIÊU LUẬN VĂN / 1.3 NỘI DUNG, PHẠM VI THỰC HIỆN]]
- [[_COMMUNITY_Community 52|Community 52]]
- [[_COMMUNITY__z()  uz()  Ou()|_z() / uz() / Ou()]]
- [[_COMMUNITY_update()  t_()  o_()|update() / t_() / o_()]]
- [[_COMMUNITY_Community 55|Community 55]]
- [[_COMMUNITY_Zn()  eI()  sE()|Zn() / eI() / sE()]]
- [[_COMMUNITY_constructor()  create()  reconfigure()|constructor() / create() / reconfigure()]]
- [[_COMMUNITY_Community 58|Community 58]]
- [[_COMMUNITY_Community 59|Community 59]]
- [[_COMMUNITY_Community 60|Community 60]]
- [[_COMMUNITY_manifest.json  author  authorUrl|manifest.json / author / authorUrl]]
- [[_COMMUNITY_manifest.json  author  authorUrl|manifest.json / author / authorUrl]]
- [[_COMMUNITY_Phạm vi cập nhật  Update Plan  Changelog|Phạm vi cập nhật / Update Plan / Changelog]]
- [[_COMMUNITY_Community 64|Community 64]]
- [[_COMMUNITY_Community 65|Community 65]]
- [[_COMMUNITY_gj()  mj()  vR()|gj() / mj() / vR()]]
- [[_COMMUNITY_addEventListener()  computeDom()  adaptTextForFakeCommit()|addEventListener() / computeDom() / adaptTextForFakeCommit()]]
- [[_COMMUNITY_Community 68|Community 68]]
- [[_COMMUNITY_Community 69|Community 69]]
- [[_COMMUNITY_Community 70|Community 70]]
- [[_COMMUNITY_Community 71|Community 71]]
- [[_COMMUNITY_Wg()  XP()  NP()|Wg() / XP() / NP()]]
- [[_COMMUNITY_CHƯƠNG 4 KẾT LUẬN  4.1 Kết quả đối chiếu với mục tiêu  4.2 Các vấn đề còn tồn đọng|CHƯƠNG 4: KẾT LUẬN / 4.1 Kết quả đối chiếu với mục tiêu / 4.2 Các vấn đề còn tồn đọng]]
- [[_COMMUNITY_Community 74|Community 74]]
- [[_COMMUNITY_Community 75|Community 75]]
- [[_COMMUNITY_Community 76|Community 76]]
- [[_COMMUNITY_Community 77|Community 77]]
- [[_COMMUNITY_a  Bm()  m_()|a / Bm() / m_()]]
- [[_COMMUNITY_resolveLocalJarCmd()  generateLocalImage()  generateLocalMap()|resolveLocalJarCmd() / generateLocalImage() / generateLocalMap()]]
- [[_COMMUNITY_Community 80|Community 80]]
- [[_COMMUNITY_Es()  CH()  FH()|Es() / CH() / FH()]]
- [[_COMMUNITY_Community 82|Community 82]]
- [[_COMMUNITY_colorOld  b  g|colorOld / b / g]]
- [[_COMMUNITY_hunks  hunkCommands  showSigns|hunks / hunkCommands / showSigns]]
- [[_COMMUNITY_colorNew  b  g|colorNew / b / g]]
- [[_COMMUNITY_m8()  isolateSignature()  Nd()|m8() / isolateSignature() / Nd()]]
- [[_COMMUNITY_Các chương  README|Các chương / README.md]]
- [[_COMMUNITY_hooks  PreToolUse  hooks.json|hooks / PreToolUse / hooks.json]]
- [[_COMMUNITY_hooks  BeforeTool  settings.json|hooks / BeforeTool / settings.json]]
- [[_COMMUNITY_Community 90|Community 90]]
- [[_COMMUNITY_Community 91|Community 91]]
- [[_COMMUNITY_Community 92|Community 92]]
- [[_COMMUNITY_Community 93|Community 93]]
- [[_COMMUNITY_AGENTS.md  graphify|AGENTS.md / graphify]]
- [[_COMMUNITY_GEMINI.md  graphify|GEMINI.md / graphify]]
- [[_COMMUNITY_appearance.json  theme|appearance.json / theme]]
...
- `"node_modules/plantuml-encoder/dist/plantuml-encoder.js"()` --calls--> `F()`  [INFERRED]
...
Cohesion: 0.05
Nodes (41): 01 - Tài Khoản Và Xác Thực, 10. BP-AUTH-009 - Admin Khóa Tài Khoản, 11. BP-AUTH-010 - Admin Mở Khóa Tài Khoản, 1. Scope, 2. BP-AUTH-001 - Đăng Ký Tài Khoản, 3. BP-AUTH-002 - Đăng Nhập, 4. BP-AUTH-003 - Đăng Xuất, 5. BP-AUTH-004 - Xem Profile (+33 more)

### Community 3 - "3.2.2 Sơ đồ tuần tự / code:plantuml (@startuml)"
Cohesion: 0.05
...
### Community 4 - "3.2.3 Sơ đồ hoạt động (activity) / code:plantuml (@startuml)"
Cohesion: 0.05
...
### Community 5 - "data.json / authorInHistoryView / autoBackupAfterFileChange"
Cohesion: 0.05
...
### Community 29 - "getRepo() / wrapFS() / fetch()"
Cohesion: 0.04
...
Cohesion: 0.06
Nodes (29): 04 - Admin Quản Lý Khách Sạn Và Phòng, 10. BP-HR-008 - Xóa Phòng, 1. Scope, 2. Shared Rules, 3. BP-HR-001 - Xem Danh Sách Khách Sạn Của Tôi, 4. BP-HR-002 - Thêm Khách Sạn Mới, 5. BP-HR-003 - Cập Nhật Khách Sạn, 6. BP-HR-004 - Xóa Khách Sạn (+21 more)

### Community 38 - "add() / ensure() / append()"
Cohesion: 0.08
...
### Community 39 - "lineAuthor / authorDisplay / coloringMaxAge"
Cohesion: 0.14
...
Cohesion: 0.25
Nodes (8): 2.1 Base URL, 2.2 Authentication, 2.3 Standard Success Response, 2.4 Standard Error Response, 2.5 Pagination Query, 2. API Conventions, code:json ({), code:json ({)

### Community 77 - "Community 77"
Cohesion: 0.25
Nodes (8): 3.3 Logout, 3.4 Change Password, 3. Auth APIs, code:json ({), code:json ({), Errors, Request, Response

### Community 78 - "a / Bm() / m_()"
Cohesion: 0.15
Nodes (12): 1. Nguyên Tắc Làm Việc, 2. Thứ Tự Đọc Tài Liệu SDD, 3. Cách Trace Requirement End-To-End, 4. Quy Tắc Khi Thêm Feature Mới, 5. Checklist Cập Nhật Docs, 6. Open Policy Cần Hỏi Người Dùng, 7. Guardrails Booking, Availability, Permission, 8. Tín Hiệu Cần Dừng Và Hỏi Lại (+4 more)
...
Cohesion: 0.33
Nodes (6): 3.1 Register, code:json ({), code:json ({), Errors, Request, Response

### Community 83 - "colorOld / b / g"
Cohesion: 0.50
Nodes (4): b, g, r, colorOld

### Community 84 - "hunks / hunkCommands / showSigns"
Cohesion: 0.50
Nodes (4): hunks, hunkCommands, showSigns, statusBar

### Community 85 - "colorNew / b / g"
Cohesion: 0.50
Nodes (4): b, g, r, colorNew

### Community 86 - "m8() / isolateSignature() / Nd()"
Cohesion: 0.33
Nodes (6): 3.2 Login, code:json ({), code:json ({), Errors, Request, Response

### Community 90 - "Community 90"
Cohesion: 0.40
Nodes (5): 5.1 Search Hotels Query, 5.2 Create/Update Hotel Request, 5.3 Hotel Errors, 5. Hotel APIs, code:json ({)

...
| Số phòng thực tế | `booking.room_number` |
...
| Data touched | `booking.status`, `booking.room_number` |
...
| 3 | Admin nhập/chọn số phòng thực tế. |
...
| 8 | System gán `room_number`. |
| 9 | System cập nhật status `CHECKED_IN`. |
| 10 | System trả thông báo thành công. |
...
| Rule ID | Rule |
| --- | --- |
| BR-OPS-CI-001 | Một `room_number` không được gán cho nhiều booking đang `CHECKED_IN` cùng lúc. |
